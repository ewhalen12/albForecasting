function [xf, x] = newtonNdGCR(fhand,x0,delta,epsilon)
...
tolf = 1e-6;         % function convergence tolerance
...
for iter = 1:maxIters
    ...
    [dx, ~] = mfgcr(fhand, x0, -f, delta, epsilon, maxIters); % solve linear system
